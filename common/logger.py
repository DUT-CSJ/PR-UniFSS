...
class Logger:
    ...
    @classmethod
    def save_model_miou(cls, model, epoch, val_miou, optimizer):
    ...
    def log_params(cls, model):
        ...
        for k in model.state_dict().keys():
            ...
            if k.split('.')[0] in ['backbone', 'clip', 'tokenizer', 'conv1', 'conv2', 'convk']:
